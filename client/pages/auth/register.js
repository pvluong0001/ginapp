        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-300">
            ...
            <div
                ...
                <button
                    ...
                    <span
                        className="absolute left-0 top-0 flex items-center justify-center h-full w-10 text-blue-500"><i
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className="flex items-center mb-6 -mt-4">
                            <div className="flex ml-auto">
                                <a href="#"
                                   className="inline-flex text-xs sm:text-sm text-blue-500 hover:text-blue-700">Forgot
                                    Your Password?</a>
                            </div>
                        </div>
