                ...
                <div className="px-4 mx-auto">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center">
                            <div
                                className="justify-center hover:text-blue-500 hover:bg-blue-100 rounded-full p-2 text-center">

                                <svg className="w-4 h-4 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <div
                                className="flex px-2 py-1 self-center text-sm font-medium text-gray-800 antialiased rounded-md focus:outline-none hover:bg-blue-100 hover:text-blue-500 focus:bg-blue-100">
                            ...
                            <div className="hidden md:block">
                                <div className="flex items-center ml-3 ">
                                    <a href="#"
                                       className="px-3 py-1 ml-2 self-center text-sm font-medium text-gray-800 antialiased rounded-md focus:outline-none hover:bg-blue-100 hover:text-blue-500 focus:bg-blue-100">Your
                                        work
                                    </a>
                                    <div
                                        className="flex px-3 py-1 ml-2 self-center text-sm font-medium text-gray-800 antialiased rounded-md focus:outline-none bg-blue-100 text-blue-500 focus:bg-blue-100">
                                        <a href="#" className="">Projects</a>
                                        <svg className="h-4 w-4 mt-1 ml-1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div
                                        className="flex px-3 py-1 ml-2 self-center text-sm font-medium text-gray-800 antialiased rounded-md focus:outline-none hover:bg-blue-100 hover:text-blue-500 focus:bg-blue-100">
                                    ...
                                    <a href="#"
                                       className="px-3 py-1 ml-2 self-center text-sm font-medium text-gray-800 antialiased rounded-md focus:outline-none hover:bg-blue-100 hover:text-blue-500 focus:bg-blue-100">People</a>
                                    ...
                                    <a href="#"
                                       className="px-3 py-1 self-center ml-2 text-sm font-medium antialiased rounded bg-blue-800 text-white">Create</a>
                                </div>
                            </div>
                        </div>
                        <div className="hidden md:block">
                            <div className="flex items-center ml-4 md:ml-6">
                                ...
                                <button
                                    ...
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 511.156 511.156"
                                ...
                                <div className="relative ml-2">
                                    <button
                                        ...
                                        <img className="w-6 h-6 rounded-full"
                                             src="https://media-exp1.licdn.com/dms/image/C4E03AQH5UhdTI6_h4A/profile-displayphoto-shrink_200_200/0?e=1600300800&v=beta&t=eK7436PgWU4lW83_6HsuePxHj1LpJW-M-1blsqreoV4"
                                             alt=""/>
                                    </button>
                                </div>
                            </div>
                ...
                <div className="flex-col border-r mt-16 pl-5 w-1/5 bg-gray-100 h-auto">
                    <div className="flex ml-3 py-8">
                        <div className="h-8 w-8 rounded">
                            <img className="h-8 w-12 mt-1 rounded "
                                 src="https://www.noeticitservices.com/images/hero-img05.png"/>
                        </div>
                        <div className="flex-col">
                            <div
                                className="items-center cursor-pointer px-2  mb-1 text-sm font-medium text-gray-700 hover:underline">
                                Noetic IT Service
                            </div>
                    ...
                    <div className=" px-3">
                        <div className="flex py-2 px-4 cursor-pointer hover:bg-blue-100 rounded">
                            <svg className="h-3 w-3 mt-1 text-gray-600" xmlns="http://www.w3.org/2000/svg"
                                 fill="currentColor" viewBox="0 0 447.243 447.243">
                                <path fillRule="evenodd"
                    ...
                    <div className="overflow-auto" style={{height: '430px'}}>
                        <div className="flex-col px-3">
                            ...
                            <div
                                className="py-3 px-3 hover:bg-blue-100 cursor-pointer rounded text-sm text-gray-600  font-normal antialiased tracking-normal">
                                My open issues
                            </div>
                            <div
                                className="py-3 px-3 hover:bg-blue-100 cursor-pointer rounded text-sm text-gray-600  font-normal antialiased tracking-normal">
                            ...
                            <div
                                className="py-3 px-3 bg-blue-100 cursor-pointer rounded text-sm text-gray-600  font-normal antialiased tracking-normal">
                                All issues
                            </div>
                            <div
                                className="py-3 px-3 hover:bg-blue-100 cursor-pointer rounded text-sm text-gray-600  font-normal antialiased tracking-normal">
                            ...
                            <div className="border border-gray-300 mt-5"></div>
                            <div
                                className="cursor-pointer py-3 px-3 mb-5 mt-5 hover:bg-blue-100 rounded text-sm text-gray-600  font-normal antialiased tracking-normal">
                                View all filters
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex w-4/5 mt-24 h-auto">
                    <div className=" ml-10 h-full" style={{width: '400px'}}>
                        ...
                        <div className="flex mt-5 w-full">
                            <input type="text" className="w-1/2 h-7 px-2 text-gray-500 border rounded text-xs"
                                   placeholder="Filter Issue ..."/>
                            <div
                                className="items-center cursor-pointer px-2  mb-1 text-sm text-blue-500 hover:underline">Advanced
                                search
                            </div>
                        </div>
                        <div className="bg-gray-100 mt-4 rounded">
                            <div className="flex  justify-between px-1 text-center items-center">
                                <div
                                    className="flex px-3 py-1 self-center text-sm font-medium text-gray-800 antialiased rounded-md focus:outline-none hover:bg-blue-100 text-blue-500 focus:bg-blue-100">
                                    <a href="#" className="">Priority</a>
                                    <svg className="h-4 w-4 mt-1 ml-1" xmlns="http://www.w3.org/2000/svg"
                                         fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd"
                                              d="M4.516 7.548c.436-.446 1.043-.481 1.576 0L10 11.295l3.908-3.747c.533-.481 1.141-.446 1.574 0 .436.445.408 1.197 0 1.615-.406.418-4.695 4.502-4.695 4.502a1.095 1.095 0 01-1.576 0S4.924 9.581 4.516 9.163c-.409-.418-.436-1.17 0-1.615z"/>
                                ...
                                <div className="p-2">
                                    <button
                                        ...
                                        <svg className="h-3 w-3 " xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                             viewBox="0 0 512 512">
                                            <path fillRule="evenodd"
                            ...
                            <div className="mx-2 bg-white rounded">
                                <div className="overflow-auto flex-col" style={{height: '308px'}}>
                                    <div className="flex-col cursor-pointer rounded hover:bg-blue-100">
                                        <div
                                            className="py-3 px-3 cursor-pointer text-gray-700 rounded text-sm font-normal antialiased tracking-normal">
                                            Selected Options : Tracked
                                        </div>
                                        <div className="flex px-3 justify-between">
                                            <div className="flex">
                                                <div className="bg-red-500 rounded h-4 w-4 p-1">
                                                    <svg className="h-2 w-2 text-white" fill="currentColor "
                                            ...
                                            <button
                                                className="flex rounded-full p-1 pb-1 h-6 w-6 bg-orange-500 justify-around">
                            ...
                            <div className="flex  justify-between px-1 text-center items-center">
                                ...
                                <div className="p-2">
                                    <button
                                        className="flex rounded px-4 py-2 focus:outline-none text-gray-500 hover:bg-blue-100 justify-around">
                                        <svg className="h-4 w-4 " xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                             viewBox="0 0 20 20">
                                            <path fillRule="evenodd"
                                ...
                                <div
                                    className="flex px-3 py-1 self-center text-sm antialiased rounded-md text-gray-600 ">
                                    issue 48 of 88
                                </div>
                            </div>
                    ...
                    <div className="w-full relative ml-10  pt-32">
                        <div
                            className="absolute hover:text-blue-500 mb-64 right-0 top-0 underline cursor-pointer mr-16 mt-5 text-sm text-gray-700  font-semibold antialiased tracking-normal">Give
                            feedback
                        </div>
                        ...
                        <div className="flex w-full justify-between px-1 text-center items-center">
                            <div className="p-2 flex">
                                <div
                                    className="py-3 cursor-pointer text-sm text-gray-600  font-normal antialiased tracking-normal">
                                    NITSWEBAPP-49 /
                                </div>
                                <div className="flex ml-2 mt-3">
                                    ...
                                    <div
                                        className="cursor-pointer ml-1 text-sm text-gray-600  font-normal antialiased tracking-normal">
                                        NITSWEBAPP-05
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex overflow-auto" style={{height: '350px'}}>
                            <div className="mr-10" style={{width: '458px'}}>
                                ...
                                <div className="flex mt-1">
                                    <div
                                        className="flex py-1 px-3 mr-2 cursor-pointer bg-gray-200 hover:bg-gray-300 rounded">
                                        <svg className="h-5 w-5 text-gray-700" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                            <path fillRule="evenodd"
                                        ...
                                        <div
                                            className="ml-2 text-sm text-gray-700  font-normal antialiased tracking-normal">
                                            Attach
                                        </div>
                                    </div>
                                    <div
                                    ...
                                    <div
                                        className="flex py-1 px-3 mr-1 cursor-pointer bg-gray-200 hover:bg-gray-300 rounded">
                                        <svg className="h-5 w-5 text-gray-700" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                            <path fillRule="evenodd"
                                    ...
                                    <div className="py-1 px-2 cursor-pointer bg-gray-200 hover:bg-gray-300 rounded">
                                        <svg className="h-4 w-4 text-gray-700" xmlns="http://www.w3.org/2000/svg"
                                             fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd"
                                                  d="M4.516 7.548c.436-.446 1.043-.481 1.576 0L10 11.295l3.908-3.747c.533-.481 1.141-.446 1.574 0 .436.445.408 1.197 0 1.615-.406.418-4.695 4.502-4.695 4.502a1.095 1.095 0 01-1.576 0S4.924 9.581 4.516 9.163c-.409-.418-.436-1.17 0-1.615z"/>
                                        </svg>
                                ...
                                <div className="flex-col p-2 rounded hover:bg-gray-200">
                                    <div className="flex">
                                        <div className="h-5 w-5">
                                            <svg className="h-5 w-5 text-gray-600" fill="currentColor"
                                                 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                                <path fillRule="evenodd"
                                        ...
                                        <div
                                            className="text-sm ml-1 text-gray-800 antialiased tracking-normal font-normal ">
                                ...
                                <div className="flex p-2 rounded">
                                    <div className="flex">
                                        <div
                                            className="text-sm ml-1 py-1 text-gray-800 antialiased tracking-normal font-normal ">
                                            Show :
                                        </div>
                                        <div
                                            className="text-sm ml-2 py-1 cursor-pointer rounded px-2 text-white bg-gray-700 antialiased tracking-normal font-normal ">
                                            Comments
                                        </div>
                                        <div
                                            className="text-sm ml-2 py-1 cursor-pointer rounded px-2 text-gray-800 bg-gray-200 antialiased tracking-normal font-normal ">
                                            History
                                        </div>
                                        <div
                                            className="text-sm ml-2 py-1 cursor-pointer rounded px-2 text-gray-800 bg-gray-200 text-gray-800 antialiased tracking-normal font-normal ">
                                            Work Log
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="items-center flex py-1 mt-5 text-sm font-medium text-gray-800">
                                    <img className="h-10 w-10 rounded-full mr-8"
                                         src="https://pbs.twimg.com/profile_images/1297819051180167170/5dL0GX4B_400x400.jpg"/>
                            ...
                            <div className="bg-white rounded" style={{width: '240px'}}>
                                <div className=" px-1 text-center items-center">
                                    <div
                                        className="flex w-24 px-3 py-2 self-center text-sm font-medium antialiased rounded bg-blue-800 text-white">
                                ...
                                <div className="mx-2 bg-white rounded">
                                    <div className="flex-col">
                                        <div className="flex-col mt-3 rounded">
                                            <div
                                                className="py-1 px-1 text-gray-700 rounded text-xs font-semibold antialiased tracking-normal">
                                                Assignee
                                            </div>
                                        ...
                                        <div className="flex-col mt-3 rounded">
                                            ...
                                            <div className="flex px-2 py-2 hover:bg-gray-200">
                                                <img className="w-6 h-6 rounded-full"
                                                     src="https://www.noeticitservices.com/images/nitish.jpg" alt=""/>
                                                <div className="font-normal text-gray-700 ml-3 text-xs">
                                                    Nitish Kumar
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex-col mt-3 rounded">
                                            ...
                                            <div className="flex px-1 py-2 hover:bg-gray-200">
                                                <div
                                                    className="font-normal bg-purple-300 p-1 underline hover:bg-transparent rounded text-gray-700 ml-3 text-xs">
                                                    Nitseditor-frontend
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex-col mt-3 rounded">
                                            ...
                                            <div className="px-2 py-2 hover:bg-gray-200">
                                                <div
                                                    className="font-normal text-gray-700 hover:text-blue-500 hover:underline ml-3 text-xs">
                                        ...
                                        <div className="flex-col mt-3 rounded">
                                            ...
                                            <div className="flex px-2 py-2 hover:bg-gray-200">
                                                <svg className="h-4 w-4 text-yellow-500 " fill="currentColor "
                                                     xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        ...
                                        <div className="flex-col mt-3 rounded">
                                            <div className="px-2 py-2 hover:bg-gray-200">
                                                <div
                                                    className="flex self-center text-sm font-medium antialiased rounded text-blue-500">
                                                    <svg className="h-4 w-4 mt-1 ml-1"
                                                ...
                                                <div
                                                    className="text-xs pl-3 font-light antialiased rounded text-gray-500">
