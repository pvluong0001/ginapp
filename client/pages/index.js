                ...
                <nav id="header" className="fixed w-full z-30 top-0 text-white">
                    <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                        ...
                        <div
                            ...
                            <button
                                id="navAction"
                                className="button mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                    ...
                    <div className="container max-w-5xl mx-auto m-8">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <div className="w-full sm:w-1/2 p-6">
                                <svg className="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5"
                                    ...
                                    <path transform="translate(-11.5 -150.75)"
                                          ...
                                          stroke="#f2f2f2" strokeMiterlimit="10" strokeWidth="2"/>
                                    <path transform="translate(-11.5 -150.75)"
                                          d="M325.38,467.23l8.3,13,35.53,55.59a66.5,66.5,0,0,1-103.32-8.57l43.54-84.94.91,1.43"
                                          fill="none" stroke="#f2f2f2" strokeLinecap="round" strokeLinejoin="round"
                                          strokeWidth="2"/>
                                    <path
                                        transform="translate(-11.5 -150.75)"
                                    ...
                                    <path transform="translate(-11.5 -150.75)"
                                          ...
                                          fill="none" stroke="#f2f2f2" strokeMiterlimit="10" strokeWidth="2"/>
                        ...
                        <div className="flex flex-wrap flex-col-reverse sm:flex-row">
                            <div className="w-full sm:w-1/2 p-6 mt-6">
                                <svg className="w-5/6 sm:h-64 mx-auto" viewBox="0 0 1176.60617 873.97852"
                                     xmlns="http://www.w3.org/2000/svg">
